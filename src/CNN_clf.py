...
def main():
    ...
    epochs = 100
    batch_size = 32
    nn_model = KerasClassifier(model=MODELS.CNN, num_outputs=num_classes, MAX_NB_WORDS = config.MAX_NB_WORDS, EMBEDDING_DIM = config.EMBEDDING_DIM, 
    ...
    print("[CNN]Precision: " + str(precision) + " Recall: " + str(recall) + " F-Score: " + str(fscore) + " AC@3: " + str(topk) + "\n")
